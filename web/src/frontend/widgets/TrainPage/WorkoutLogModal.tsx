...
import { Modal, Button } from '@frontend/shared/ui';
import { midnight } from '@frontend/shared/lib/utils/format';
import {
  WD_FULL, fmtDate, lastSetsString, parseDefaultSets, dayOfWeek,
} from '@frontend/shared/lib/train';
import type { WorkoutTemplate, ExerciseTemplate } from '@frontend/shared/types';
