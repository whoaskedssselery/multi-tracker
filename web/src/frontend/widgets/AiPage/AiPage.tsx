...
import { askGroq, GroqError, type ChatTurn } from '@frontend/shared/lib/ai/groq';
import { buildContext, type AiFilter } from '@frontend/shared/lib/ai/context';
      ...
      <div className={styles.messages} ref={scrollRef}>
        {msgs.length === 0 ? (
          <div className={styles.empty}>
            <div className={styles.emptyBadge}>ИИ</div>
