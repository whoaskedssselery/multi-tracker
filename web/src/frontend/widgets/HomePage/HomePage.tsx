...
import { WeightChart, WeightHistoryList } from '@frontend/entities/weight';
import { GoalItem } from '@frontend/entities/goal';
import { WeightRecorder } from '@frontend/features/weight';
import { GoalForm } from '@frontend/features/goal';
import { formatSyncTime, dayWord, taskWord } from '@frontend/shared/lib/utils/format';
