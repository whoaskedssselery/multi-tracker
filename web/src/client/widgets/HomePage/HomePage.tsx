...
import { WeightChart, WeightHistoryList } from '@client/entities/weight';
import { GoalItem } from '@client/entities/goal';
import { WeightRecorder } from '@client/features/weight';
import { GoalForm } from '@client/features/goal';
import { formatSyncTime, dayWord, taskWord } from '@client/shared/lib/utils/format';
