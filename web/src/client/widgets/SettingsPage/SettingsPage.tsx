...
import { createClient } from '@client/shared/lib/supabase/client';
import { Modal, Button, Input } from '@client/shared/ui';
import { useSync } from '@client/features/sync';
import { formatSyncTime } from '@client/shared/lib/utils/format';
import type { ThemeMode } from '@client/shared/types';
